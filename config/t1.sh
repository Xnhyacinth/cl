...
for item in $ranks; do
    ...
    bash config/run2.sh 2 1,7 t5-large vida 2 constant 1e-4 0 all 0 8 -1 $item $r2 0 0 4
done
ranks="2"
for item in $ranks; do
    echo "Item: $item"
    ...
    bash config/run1.sh 2 1,7 t5-large vida 2 constant 1e-4 0 all 0 8 -1 $item $r2 0 0 4
done
ranks="4 2"
for item in $ranks; do
    echo "Item: $item"
